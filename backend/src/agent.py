...
# ==========================================
# 2. STRICT SYSTEM PROMPT (OUTBOUND COMPLIANCE & DAY 7 HUMAN ESCALATION)
# ==========================================
...
GROUNDING & SAFETY:
Never give medical advice. Never give unverified market prices. Ensure NO private data (passwords/bank details) is sent in the summary or spoken. Refuse harmful or illegal requests politely. Keep answers concise and under 30 words per turn.
"""
