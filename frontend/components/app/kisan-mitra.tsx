    ...
    <header className="sticky top-0 z-40 w-full border-b border-emerald-200/60 bg-white/70 backdrop-blur-md transition-colors dark:border-emerald-900/50 dark:bg-[#021810]/70">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 sm:gap-3.5">
          <div className="flex size-11 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-500 via-green-500 to-lime-400 text-2xl text-white shadow-md shadow-emerald-500/20 select-none sm:size-12">
            🌾
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-black tracking-tight text-emerald-950 sm:text-2xl dark:text-emerald-50">
                KisanMitra AI
              </h1>
            ...
            <p className="text-[11px] font-semibold tracking-wide text-emerald-700 sm:text-xs dark:text-emerald-400">
              Developed by Rishabh Kumar
            </p>
          </div>
        </div>

        {/* Right: Dashboard Link + Badge "Murf Falcon | LiveKit" + ThemeToggle */}
        <div className="flex items-center gap-2 sm:gap-3.5">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-1.5 rounded-full border border-emerald-300/80 bg-white/90 px-3.5 py-1.5 text-xs font-bold text-emerald-900 shadow-xs transition-all duration-200 hover:scale-105 hover:bg-emerald-100 hover:text-emerald-950 dark:border-emerald-700/60 dark:bg-emerald-950/80 dark:text-emerald-300 dark:hover:bg-emerald-900"
            title="कॉलिंग एनालिटिक्स डैशबोर्ड देखें"
          >
            <span>📊</span>
            <span>कॉल एनालिटिक्स (Dashboard)</span>
          </Link>

          <div className="hidden items-center gap-1.5 rounded-full border border-emerald-300/80 bg-emerald-100/90 px-3 py-1.5 text-xs font-bold text-emerald-900 shadow-xs md:flex dark:border-emerald-700/60 dark:bg-emerald-950/80 dark:text-emerald-300">
